...
import { QueueArrayImpl as Queue } from './../../../koans/ds/queue/index.js';



const MSG = "Queue array implementation FAIL!\n"
+ "See file: ds/queue/001-array-implementation.js";

function test(){

  let q = new Queue(5);

  assert.deepStrictEqual(q.isEmpty(), true, MSG);
  assert.deepStrictEqual(q.isFull(), false, MSG);
  ...
  assert.deepStrictEqual(q.isEmpty(), false, MSG);
  assert.deepStrictEqual(q.isFull(), false, MSG);
  ...
  assert.deepStrictEqual(q.isEmpty(), false, MSG);
  assert.deepStrictEqual(q.isFull(), true, MSG);
  assert.deepStrictEqual(q.getFront(), 30, MSG);
